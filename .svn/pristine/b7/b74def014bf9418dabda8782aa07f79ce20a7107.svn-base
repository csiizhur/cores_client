 ...
 *
 */
public class SerialPortEventListener_chipAnimalSelect implements SerialPortEventListener{
	...
	static class Task implements Runnable{
		...
		@Override
		public void run() {
			AnimalChipSelectPage.getInstance().selectAnimalByICardCode(iCardCode);
		}
	}
}